						...
						<section class="movie_area">
							...
							<div class="list">
								<div class="contents_area">
                                  <div class="ph"><a class="inline_contents cboxElement" href="#movie<?php echo get_the_ID(); ?>"><img src="http://img.youtube.com/vi/<?php $movie_id = get_field('movie_id'); if( $movie_id ): ?><?php echo $movie_id; ?><?php endif; ?>/maxresdefault.jpg"></a></div>
                                  <div class="txt">
