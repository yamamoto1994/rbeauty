<?php get_header(); ?>
			<section class="menu">
				...
				<div class="ttl_area tokusyu">
					<div class="inner">
						<h1 class="title"><?php $menu_fv_ph_tokusyu = get_field('menu_fv_ph_tokusyu'); if( $menu_fv_ph_tokusyu ): ?><img src="<?php echo $menu_fv_ph_tokusyu; ?>" alt="<?php the_title(); ?>"><?php endif; ?></h1>
					</div>
				</div>
				<?php else:?>
...
<?php elseif ($cat == '詳細情報セクション') :?>	
				<?php if( have_rows('menu_details_area') ): ?><?php while( have_rows('menu_details_area') ): the_row();?>
                  <?php $menu_details_no = get_sub_field('menu_details_no'); if( $menu_details_no ): ?><div class="btn btn_black btn_bottom"><a href="#<?php echo $menu_details_no; ?>"><?php $menu_details_name = get_sub_field('menu_details_name'); if( $menu_details_name ): ?><?php echo $menu_details_name; ?><?php else: ?>詳細情報<?php endif; ?></a></div><?php endif; ?>
				<?php endwhile; endif; ?>	
...
<?php elseif ($cat == '詳細情報セクション') :?>
				...
				<section class="menu_details_area bg_pink_yellow ico" id="<?php $menu_details_no = get_sub_field('menu_details_no'); if( $menu_details_no ): ?><?php echo $menu_details_no; ?><?php endif; ?>">
					<div class="inner">
						<h2 class="sub_title"><?php the_title(); ?>の詳細情報</h2>
