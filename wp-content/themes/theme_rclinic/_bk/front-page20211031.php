...
<div class="swiper-wrapper">
<!-- Slides -->
<div class="swiper-slide"><a href="<?php echo esc_url(home_url('/')); ?>campaign"><img src="<?php echo get_template_directory_uri(); ?>/images/top/cp-bnr11.jpg" alt="11月限定キャンペーン"></a></div>
...
<div class="swiper-slide"><a class="inline_contents" href="#banner_contents02" rel="banner_modal"><img src="<?php echo get_template_directory_uri(); ?>/images/top/cp-eye11-bnr.jpg" alt="症例モニター募集中　二重整形 埋没法R式クイックイ"></a></div>
<div class="swiper-slide"><a class="inline_contents" href="#banner_contents03" rel="banner_modal"><img src="<?php echo get_template_directory_uri(); ?>/images/top/cp-bnr02.jpg" alt="11月限定CP 鼻プロテーゼ"></a></div>
<div class="swiper-slide"><a class="inline_contents" href="#banner_contents04" rel="banner_modal"><img src="<?php echo get_template_directory_uri(); ?>/images/top/cp-bnr03.jpg" alt="11月限定CP ダーマペン4"></a></div>
