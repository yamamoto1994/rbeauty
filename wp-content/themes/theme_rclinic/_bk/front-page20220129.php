<?php get_header(); ?>
			...
			<li><a href="<?php echo esc_url(home_url('/')); ?>trouble/858/">
			<img src="<?php echo get_template_directory_uri(); ?>/images/top/pickup-01.jpg" alt="目頭切開"></a></li>
			<li><a href="<?php echo esc_url(home_url('/')); ?>trouble/1885/">
			<img src="<?php echo get_template_directory_uri(); ?>/images/top/pickup-02.jpg" alt="人中短縮"></a></li>
			<li><a href="<?php echo esc_url(home_url('/')); ?>trouble/593/">
			<img src="<?php echo get_template_directory_uri(); ?>/images/top/pickup-03.jpg" alt="糸リフト"></a></li>
			<li><a href="<?php echo esc_url(home_url('/')); ?>trouble/400/">
			<img src="<?php echo get_template_directory_uri(); ?>/images/top/pickup-04.jpg" alt="プロテーゼ"></a></li>
			<li><a href="<?php echo esc_url(home_url('/')); ?>trouble/5419/">
			<img src="<?php echo get_template_directory_uri(); ?>/images/top/pickup-05.jpg" alt="スネコス注射"></a></li>
			</ul>
