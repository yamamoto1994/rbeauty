<?php get_header(); ?>
			<section class="menu">
	          ...
	          <?php if(is_single(array('978','3591','1040','593'))): ?><source media="(max-width: 680px)" srcset="<?php echo get_template_directory_uri().'/images/menu/menu_fv_'.$post->post_name.'_sp.jpg'?>" alt="<?php the_title(); ?>"><?php else: ?><?php endif; ?>
