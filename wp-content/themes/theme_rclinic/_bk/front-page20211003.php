...
<div class="inner">
<a href="<?php echo esc_url(home_url('/')); ?>beautygirl01/"><figure><img src="<?php echo get_template_directory_uri(); ?>/images/b-story/bnr-top01.jpg" alt="憧れのアノ人は何を受けた？整形ヒストリー大公開"></figure></a>
</div>
</section>
				...
				<section class="face trouble_contents_area">
                    ...
                    <div class="trouble_list_area bg_pink_yellow">
						<div class="inner">
                            ...
                            <div class="ph"><img src="<?php echo get_template_directory_uri(); ?>/images/trouble_face_ph.png" alt=""></div>
					...
					<div class="ico ico01 fadein"><img src="<?php echo get_template_directory_uri(); ?>/images/ico_square_pink.png" alt=""></div>
					<div class="ico ico02 fadein"><img src="<?php echo get_template_directory_uri(); ?>/images/ico_square_green.png" alt=""></div>
					<div class="ico ico03 fadein"><img src="<?php echo get_template_directory_uri(); ?>/images/ico_square_blue.png" alt=""></div>
				</section>
				<section class="body trouble_contents_area">
                    ...
                    <div class="trouble_list_area bg_blue_purple">
						<div class="inner">
                            ...
                            <div class="ph"><img src="<?php echo get_template_directory_uri(); ?>/images/trouble_body_ph.png" alt=""></div>
                            <div class="trouble_list">
					...
					<div class="ico ico01 fadein"><img src="<?php echo get_template_directory_uri(); ?>/images/ico_square_yellow.png" alt=""></div>
					<div class="ico ico02 fadein"><img src="<?php echo get_template_directory_uri(); ?>/images/ico_square_blue.png" alt=""></div>
					<div class="ico ico03 fadein"><img src="<?php echo get_template_directory_uri(); ?>/images/ico_square_purple.png" alt=""></div>
				</section>
				<section class="skin trouble_contents_area">
                    ...
                    <div class="trouble_list_area bg_orange_blue">
						<div class="inner">
                            ...
                            <div class="ph"><img class="pc" src="<?php echo get_template_directory_uri(); ?>/images/trouble_skin_ph.png" alt=""><img class="sp" src="<?php echo get_template_directory_uri(); ?>/images/trouble_skin_ph_sp.png" alt=""></div>
                            <div class="trouble_list">
					...
					<div class="ico ico02 fadein"><img src="<?php echo get_template_directory_uri(); ?>/images/ico_square_green.png" alt=""></div>
					<div class="ico ico03 fadein"><img src="<?php echo get_template_directory_uri(); ?>/images/ico_square_pink.png" alt=""></div>
				</section>
			</section>
<?php endwhile;endif; ?>
                        ...
                        <?php
                          ...
                          <li>
							  <a href="<?php echo esc_url(home_url('/')); ?>menu/menu_surgery#<?php echo $value->slug; ?>">
							   <div class="ph"><img src="<?php $cate_ph = get_field('cate_ph','category_'.$value->term_id); ?><?php echo $cate_ph; ?>" alt=""></div>
                  ...
                  <div class="swiper-wrapper loop">
                    ...
                    <?php if (have_posts()) : while(have_posts()) : the_post(); ?>
                      <div class="swiper-slide case_hv"><a class="inline_contents" href="#case_insta_contents<?php echo get_the_ID(); ?>" rel="case_insta_modal">
                          <?php $case_insta_radio = get_field('case_insta_radio'); if ($case_insta_radio == "画像"): ?><img src="<?php $case_insta_ph = get_field('case_insta_ph'); ?><?php echo $case_insta_ph; ?>" alt=""><?php elseif ($case_insta_radio == "動画"): ?>
...
<?php $top_sns = get_field('top_sns'); if( $top_sns ){ echo $top_sns; }?>
 ...
 <?php query_posts( array( 'post_type' =>array('movie'),'posts_per_page' => 6 )); ?>
                    <?php if (have_posts()) : while(have_posts()) : the_post(); ?>
                          <div class="swiper-slide"><div class="movie"><iframe src="https://www.youtube.com/embed/<?php $movie_id = get_field('movie_id'); if( $movie_id ): ?><?php echo $movie_id; ?><?php endif; ?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div></div>
<?php endwhile; endif;wp_reset_query();?>
                        </div>
                    </div>
