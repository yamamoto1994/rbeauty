...
<title>アールビューティークリニック 名古屋院｜美容整形・美容外科・美容皮膚科</title>
...
<?php if(is_front_page() || is_page('clinic-nagoya') ) {
...
<?php endif ?>
<?php if ( is_page(array('1125','5153','5164','5410','5453','5492'))) : ?>
...
<div class="pop_area">
<div class="inner">
<div class="ph"><a href="https://lin.ee/y5Ejtoy" target="_blank"><img class="pc" src="<?php echo get_template_directory_uri(); ?>/images/top/pop_linefriend_nagoya.png" alt=""><img class="sp" src="<?php echo get_template_directory_uri(); ?>/images/top/pop_linefriend_nagoya_sp.png" alt=""></a>
<div class="pop_close"><span></span></div>
		...
		<header>
			...
			<div class="inner">
                <div class="navBtnArea sp">
					...
					<div class="logo"><a href="<?php echo esc_url(home_url('/')); ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/logo.svg" alt="アールビューティークリニック 名古屋｜美容整形・美容外科・美容皮膚科"></a></div>
				<nav class="dNav pc">
					<ul>
						<li class="tel_area">
						...
						<li class="line_btn_area"><a href="https://lin.ee/y5Ejtoy" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/images/ico_line_green.svg" alt=""><span>LINE相談</span></a>
						<div class="line_hukidashi"><img src="<?php echo get_template_directory_uri(); ?>/images/ico_gift.svg" alt="">クーポン配信中！</div>
            </li>
					</ul>
				</nav>
			</div>
        ...
        <div class="sp btn_area sp_btn_area f-kotei">
            <div class="line_btn_area"><a class="" href="https://lin.ee/y5Ejtoy" target="_blank"><em>24H受付</em><img src="<?php echo get_template_directory_uri(); ?>/images/ico_line_w.svg" alt="">LINE予約</a></div>
          ...
          <h2 class="sp_nav_stitle"><a href="<?php echo esc_url(home_url('/')); ?>access-nagoya/" id="header-sp-acc">アクセス</a></h2>
          <h2 class="sp_nav_stitle"><a href="<?php echo esc_url(home_url('/')); ?>doctor" id="header-sp-dr">ドクター紹介</a></h2>
          <h2 class="sp_nav_stitle"><a href="<?php echo esc_url(home_url('/')); ?>clinic" id="header-sp-clinic">クリニック案内</a></h2>
          ...
          <li><a href="<?php echo esc_url(home_url('/')); ?>access-nagoya/" id="header-pc-access">アクセス</a></li>
    ...
    <div class="sp fixed_nav sp_btn_area f-kotei">
        <div class="line_btn_area"><a class="" href="https://lin.ee/y5Ejtoy" target="_blank"><em>24H受付</em><img src="<?php echo get_template_directory_uri(); ?>/images/ico_line_w.svg" alt="">LINE予約</a><div class="line_hukidashi"><img src="<?php echo get_template_directory_uri(); ?>/images/ico_gift.svg" alt="">クーポン配信中！</div></div>
        <div class="f-moni"><a class="" href="<?php echo esc_url(home_url('/')); ?>monitor"><em>24H受付</em><img src="<?php echo get_template_directory_uri(); ?>/images/ico_moni.svg" alt="">モニター募集</a></div>
        <div class="f-tel"><a class="" href="tel:03-6228-7881"><em>10時-19時</em><img src="<?php echo get_template_directory_uri(); ?>/images/ico_tel_w.svg" alt="TEL">電話予約</a></div>
