<?php get_header(); ?>
			...
			<img src="<?php echo get_template_directory_uri(); ?>/images/top/pickup07.jpg" alt="小顔治療　R式糸リフト"></a></li>
...
<div class="swiper-slide"><a class="inline_contents" href="#banner_contents05" rel="banner_modal" id="t-cp-04"><img src="<?php echo get_template_directory_uri(); ?>/images/top/cp-bnr04.jpg" alt="11月限定CP R式糸リフト"></a></div>
...
<h2 class="serif">【11月限定CP】小顔+美肌治療</h2>
<div class="banner_flex_area">
<div class="ph"><img src="<?php echo get_template_directory_uri(); ?>/images/top/cp-bnr04-thum.jpg" alt="【11月限定CP】小顔+美肌治療"></div>
<div class="modal_banner_contents_area">
<div class="modal_banner_contents">
<div class="txt_area">
<p>たるみ改善と美肌のダブルが叶う小顔治療！<br>
【11月限定CP】R式糸リフト<br>
通常2本￥60,000〜　→CP価格￥40,000〜<br>
</p>
</div>
</div>
<div class="modal_banner_contents">
<div class="txt_area gray_box">
<p class="with-checked">小顔にしたい</p>
<p class="with-checked">ほうれい線が気になる</p>
<p class="with-checked">メスは入れたくない</p>
<p class="with-checked">バレたくないし、あまり休みがとれない</p>
<p>こんな方にオススメです！</p>
</div>
</div>
<div class="modal_banner_contents">
...
<div class="btn_area btn_flex_area btn_flex_c_area">
<div class="btn btn_gray btn_hv_black btn_w280"><a href="<?php echo esc_url(home_url('/')); ?>trouble/593/">施術について詳しく見る</a></div>
<div class="btn btn_bg_black btn_hv_black btn_hv_white btn_w280"><a href="<?php echo esc_url(home_url('/')); ?>reserve/" rel="noopener noreferrer">予約する</a></div>
</div>
</div>
</section>
...
<h2 class="basic_list_title"><span class="en_serif en_title">Pick Up</span><span class="serif jp_title">ピックアップ</span></h2></div>
<div class="inner">
<a href="<?php echo esc_url(home_url('/')); ?>beautygirl01/" id="etc-bs"><figure><img src="<?php echo get_template_directory_uri(); ?>/images/top/bnr-momo.jpg" alt=""></figure></a>
<a href="<?php echo esc_url(home_url('/')); ?>nose-chart/" id="etc-nc"><figure><img src="<?php echo get_template_directory_uri(); ?>/images/top/bnr-nose-chart.jpg" alt=""></figure></a>
</div>
</section>
<style>
.etc_area {
