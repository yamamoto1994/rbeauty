...
function Include_my_php($params = array())
{
  ...
  ob_start();
  include(get_theme_root() . '/' . get_template() . "/tpl/$file.php");
  return ob_get_clean();
}
...
function cta_btn($atts) {
	...
	$a_link = $link;
	$a_title = $title;
	$btn = "<p class=\"cta-btn\"><a href=\"{$a_link}\" rel=\"noopener noreferrer\" target=\"_blank\">{$a_title}</a></p>";
	return $btn;
}
add_shortcode('cta', 'cta_btn');