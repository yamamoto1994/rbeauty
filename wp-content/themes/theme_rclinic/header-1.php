...
<?php endif ?>
<?php if ( is_page(array('1125','5766','5843','6132','6339','6462'))) : ?>
...
<div class="pop_area">
<div class="inner">
<div class="ph"><a href="https://lin.ee/y5Ejtoy" target="_blank"><img class="pc" src="<?php the_field('nagoya_modal_pc',6564); ?>" alt=""><img class="sp" src="<?php the_field('nagoya_modal_sp',6564); ?>" alt=""></a>
<div class="pop_close"><span></span></div>
		...
		<header>
			...
			<h1 class="head_title">
				...
				<?php endif ?> アールビューティークリニック銀座・名古屋
			</h1>
			<div class="inner">
                <div class="navBtnArea sp">
					...
					<div class="logo"><a href="<?php echo esc_url(home_url('/')); ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/logo.svg" alt="アールビューティークリニック｜美容整形・美容外科・美容皮膚科"></a></div>
				<nav class="dNav pc">
					<ul>
						<li class="tel_area">
      ...
      <nav class="gNav">
        <div class="sp btn_area sp_btn_area f-kotei">
          ...
          <div class="sp_gNav_list js_accordion">
                        ...
                        <ul class="js_accordion_content">
                          <li><a href="<?php echo esc_url(home_url('/')); ?>">銀座院</a></li>
                          <li><a href="<?php echo esc_url(home_url('/')); ?>clinic-nagoya">名古屋院</a></li>
                        </ul>
					  </div>
            ...
            <h2 class="sp_nav_stitle"><a href="<?php echo esc_url(home_url('/')); ?>access-nagoya/">アクセス</a></h2>
            ...
            <h2 class="sp_nav_stitle"><a href="<?php echo esc_url(home_url('/')); ?>faq">Q&A</a></h2>
				...
				<ul class="pc">
					...
					<li class="current_list clinic-adjust"><a class="pc">クリニック一覧</a>
            <div class="sub_menu">
							<div class="menu_inner">
								<div class="menu_list">
                  <ul class="children">
					...
					<li><a href="<?php echo esc_url(home_url('/')); ?>access-nagoya/">アクセス</a></li>
